 ...
 */
export const BRIDGE_DOWNLOAD_URL_KEY_UPDATED = 'synopsys_bridge_download_url'
...
/**
 * @deprecated Use blackducksca_install_directory instead. This can be removed in future release.
 */
...
/**
 * @deprecated Use blackducksca_failure_severities instead. This can be removed in future release.
 */
export const BLACKDUCK_FAILURE_SEVERITIES_KEY = 'blackduck_failure_severities'
export const BLACKDUCKSCA_FAILURE_SEVERITIES_KEY = 'blackducksca_failure_severities'
/**
...
/**
 * @deprecated Use blackducksca_filter_severities instead. This can be removed in future release.
 */
...
/**
 * @deprecated Use blackducksca_useUpgradeGuidance instead. This can be removed in future release.
 */
export const BLACKDUCK_FIXPR_USE_UPGRADE_GUIDANCE_KEY = 'blackduck_fixpr_useUpgradeGuidance'
export const BLACKDUCKSCA_FIXPR_USE_UPGRADE_GUIDANCE_KEY = 'blackducksca_useUpgradeGuidance'
/**
...
/**
 * @deprecated Use blackduckscarepors_sarif_create instead. This can be removed in future release.
 */
...
/**
 * @deprecated Use blackduckscarepors_sarif_file_path instead. This can be removed in future release.
 */
...
/**
 * @deprecated Use blackduckscarepors_sarif_severities instead. This can be removed in future release.
 */
...
/**
 * @deprecated Use blackduckscarepors_groupSCAissues instead. This can be removed in future release.
 */
...
/**
 * @deprecated Use blackduck_report_upload_sarif instead. This can be removed in future release.
 */
...
/**
 * @deprecated Use blackduck_waitForScan instead. This can be removed in future release.
 */
 ...
 */
export const BLACKDUCK_POLICY_BADGES_MAXCOUNT_KEY = 'blackduck_policy_badges_maxCount'
...
export const BLACKDUCK_SARIF_GENERATOR_DIRECTORY = 'Blackduck SCA SARIF Generator Director'
...
export const BLACKDUCK_PR_COMMENT_LOG_INFO_FOR_NON_PR_SCANS = 'Black Duck PR Comment is ignored for pull request scan'
...
export const BRIDGE_CLI_URL_NOT_VALID_OS_ERROR = 'Provided Bridge CLI url is not valid for the configure'
export const BRIDGE_CLI_URL_NOT_VALID_ERROR = 'Invalid URL'
export const PROVIDED_BRIDGE_CLI_URL_EMPTY_ERROR = 'URL cannot be empty'
